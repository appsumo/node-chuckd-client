 ...
 */
ChuckDClient.prototype.getChildClient = function (extraPrefix) {
    return new ChuckDClient({
 ...
 */
ChuckDClient.prototype.single = function (appId, hashKey, rangeKey, name, value, cmd, type) {
 ...
 */
ChuckDClient.prototype.put = function (appId, hashKey, rangeKey, name, value, type) {
 ...
 */
ChuckDClient.prototype.increment = function (appId, hashKey, rangeKey, name, delta) {
 ...
 */
ChuckDClient.prototype.decrement = function (appId, hashKey, rangeKey, name, delta) {
 ...
 */
ChuckDClient.prototype.close = function () {
    this._socket.close();
};
 ...
 */
ChuckDClient.prototype.__defineGetter__('helpers', function () {
    if (!(this._helpers)) {
        var helpers = {},
            that = this,
